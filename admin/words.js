...
systemDictionary = {
    "title": {
        "en": "Husquana Automower Adapter (cloud based)",
        "de": "Husquana Automower Adapter (Cloud-basiert)",
        "ru": "Адаптер Husquana Automower (облачный)",
        "pt": "Adaptador Husquana Automower (baseado na nuvem)",
        "nl": "Husquana Automower-adapter (op basis van cloud)",
        "fr": "Husquana Automower Adapter (basé sur le cloud)",
        "it": "Husquana Automower Adapter (basato sulla cloud)",
        "es": "Adaptador Husquana Automower (basado en la nube)",
        "pl": "Adapter Husquana Automower (oparty na chmurze)"
    },
    "connection settings": {
    ...
    "pollActive": {
        "en": "query intervall mower active",
        "de": "Abfrageintervall Mäher aktiv",
    },

    "pollInactive": {
        "en": "query intervall mower inactive",
        "de": "Abfrageintervall Mäher inaktiv",
    }
